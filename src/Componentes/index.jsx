            ...
            <nav className="sb-topnav navbar navbar-expand navbar-dark bg-dark">
                ...
                <ul className="navbar-nav ms-auto ms-md-0 me-3 me-lg-4">
                    <li className="nav-item dropdown">
                        <a className="nav-link dropdown-toggle" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false" href="#!"><img src="/src/img/swarovski-1 1.svg" alt="" /></a>
